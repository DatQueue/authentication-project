...
let AuthController = class AuthController {
    ...
    async login(loginDto, res) {
        ...
        const refreshTokenExpTime = await this.authService.removeRFTDataIfTokenExpired(user.id);
        if (refreshTokenExpTime < Date.now()) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6d3aad0f0f734f3ca8e7")
/******/ })();
/******/ 
/******/ }
;