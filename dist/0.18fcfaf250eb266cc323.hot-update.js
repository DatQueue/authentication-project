...
let AuthController = class AuthController {
    ...
    async login(loginDto, res) {
        ...
        const refreshTokenValidityPeriod = await this.authService.getRefreshTokenValidityPeriod();
        console.log(refreshTokenValidityPeriod);
        setTimeout(async () => {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4927f8d858271f54b0d0")
/******/ })();
/******/ 
/******/ }
;