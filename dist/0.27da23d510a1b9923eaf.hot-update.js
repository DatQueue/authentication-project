...
const twoFactorAuthentication_controller_1 = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module './twoFA/twoFactorAuthentication.controller'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
const twoFactorAuthentication_service_1 = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module './twoFA/twoFactorAuthentication.service'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [auth_service_1.AuthService, users_service_1.UsersService, twoFactorAuthentication_service_1.TwoFactorAuthenticationService, jwt_refresh_strategy_1.JwtRefreshStrategy, jwt_access_guard_1.JwtAccessAuthGuard, jwt_refresh_guard_1.JwtRefreshGuard],
    })
], AuthModule);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("da81a079663561317811")
/******/ })();
/******/ 
/******/ }
;