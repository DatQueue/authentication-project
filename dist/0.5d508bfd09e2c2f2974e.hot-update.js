...
let AuthController = class AuthController {
    ...
    async refresh(refreshTokenDto, req, res) {
        try {
            const newAccessToken = (await this.authService.refresh(refreshTokenDto, req.user.id)).accessToken;
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_f = typeof refreshToken_dto_1.RefreshTokenDto !== "undefined" && refreshToken_dto_1.RefreshTokenDto) === "function" ? _f : Object, Object, typeof (_g = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _g : Object]),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3f1c88762134dcfc89ee")
/******/ })();
/******/ 
/******/ }
;